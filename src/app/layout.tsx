...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'JokiCoding — Jasa Tugas Ngoding, Skripsi, Jurnal & Multimedia',
    description: 'Layanan pengerjaan tugas profesional untuk mahasiswa & bisnis. Edit video, CV, PPT, skripsi, jurnal, ngoding, & hosting.',
